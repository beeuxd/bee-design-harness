...
5. Visual verification with Playwright screenshots, dark mode first, at 360 / 768 / 1024 / 1440 / 1920px (sweep script in `responsive-implementation`; design review per `visual-qa`), on at least one page that consumes each changed token — screenshot evidence, not "it compiles".

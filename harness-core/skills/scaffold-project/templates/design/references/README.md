...
- One folder per reference: `design/references/<slug>/` containing `*.png` + `notes.md`
- The "why" column is the user's own words, verbatim — it's the most important data here
- References that contradict the art direction in `docs/design-system.md` get flagged, not silently followed
- Stale references (art direction moved on) get a `RETIRED` marker in the index, not deleted

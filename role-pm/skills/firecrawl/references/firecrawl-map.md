...
- [firecrawl-scrape](firecrawl-scrape.md) — scrape the URLs you discover
- [firecrawl-crawl](firecrawl-crawl.md) — bulk extract instead of map + scrape
- [firecrawl-download](firecrawl-download.md) — download entire site (uses map internally)

...
- [firecrawl-scrape](firecrawl-scrape.md) — try scrape first, escalate to interact only when needed
- [firecrawl-search](firecrawl-search.md) — for web searches (never use interact for searching)
- [firecrawl-agent](firecrawl-agent.md) — AI-powered extraction (less manual control)

...
- [firecrawl-scrape](firecrawl-scrape.md) — simpler single-page extraction
- [firecrawl-interact](firecrawl-interact.md) — scrape + interact for manual page interaction (more control)
- [firecrawl-crawl](firecrawl-crawl.md) — bulk extraction without AI

...
- [firecrawl-search](firecrawl-search.md) — find pages when you don't have a URL
- [firecrawl-interact](firecrawl-interact.md) — when scrape can't get the content, use `interact` to click, fill forms, etc.
- [firecrawl-download](firecrawl-download.md) — bulk download an entire site to local files

...
See [firecrawl-cli](../SKILL.md) for how paper search fits the
...
- [firecrawl-scrape](firecrawl-scrape.md) — scrape a specific URL
- [firecrawl-map](firecrawl-map.md) — discover URLs within a site
- [firecrawl-crawl](firecrawl-crawl.md) — bulk extract from a site

...
- [firecrawl-scrape](firecrawl-scrape.md) — scrape individual pages
- [firecrawl-map](firecrawl-map.md) — discover URLs before deciding to crawl
- [firecrawl-download](firecrawl-download.md) — download site to local files (uses map + scrape)

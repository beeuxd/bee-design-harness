...
> Placeholders like `~~design tool` or `~~project tracker` mean "whichever such tool is connected" (e.g., Figma, GitHub Projects). If none is connected, work from the provided description or screenshot and skip connector-only steps.

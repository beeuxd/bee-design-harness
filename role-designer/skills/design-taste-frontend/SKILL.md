...
### 9.H STRATEGIC OMISSIONS (What AI Typically Forgets)

Tells are not only what you add - they are also what you forget. Every build ships with these, unprompted:
...
Then run the existing UI through this diagnostic checklist. Every hit is a finding: fix it or consciously keep it, never leave it unexamined.

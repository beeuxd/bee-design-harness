...
- When the animation ships inside product UI (not just this previewer), gate autoplay behind `prefers-reduced-motion` — show a static first/last frame for users who opt out.

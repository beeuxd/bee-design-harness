...
**House rule overrides the WCAG minimum: interactive targets are ≥44×44px on touch** (per the harness non-negotiables) — treat 24px as a hard floor for edge cases, not a target.
